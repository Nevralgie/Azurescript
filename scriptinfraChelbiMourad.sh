...
availabilitySet="LBavailablityset"
vNet="LBVnet"
subnet="LBsubnet-lb"
loadBalancerPublicIp="LBPubip"
loadBalancerFrontEndConfig1="LBFconf1"
loadBalancerFrontEndConfig2="LBFconf2"
loadBalancer="LBmultisites"
frontEndIp="LBFrIP"
frontEndIpConfig1="LBFrIPconf1"
frontEndIpConfig2="LBFrIPconf2"
backEndPool="LBBendpool"
backEndAddressPool1="LBBendIPool1"
backEndAddressPool2="LBBendIPool2"
probe80="LBHPport80"
lbRuleConfig1="LBruleconfi1"
lbRuleConfig2="LBruleconfi2"
publicIpVm1="LBIPvm1"
nicVm1="LBvm1nic1"
ipConfig1="LBipconf1"
ipConfig2="LBipconf2"
vm1="LBvm1"
publicIpVm2="LBvm2PIP"
ipSku="Standard"
nicVm2="LBvm2nic2"
ipConfig1="LBipconf1"
ipConfig2="LBipconf2-lb"
vm2="LBvm2"
image="UbuntuLTS"
login="azureuser"
...
# Create Vm1.
echo "Creating $vm1"
az vm create --resource-group $resourceGroup --name $vm1 --nics $nicVm1 --image UbuntuLTS --availability-set $availabilitySet --public-ip-sku $ipSku --admin-username $login --generate-ssh-keys
